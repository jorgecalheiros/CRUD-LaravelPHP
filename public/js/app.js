...
function confirm() {
  ...
  if (btn) {
    ...
    var cacelar = document.getElementById("cacelar");
    var body = document.getElementById("false");
    btn.addEventListener("click", function () {
      if (_confirm.style.opacity == 0) {
        body.style.display = "block";

        _confirm.classList.add("show");
      } else {
        body.style.display = "none";

        _confirm.classList.remove("show");
      }
    });
...
function show_card_delete_post() {
  var btn = document.getElementById("btn-delete-post");
  ;
